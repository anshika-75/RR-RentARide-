...
export const dummyCarData = [
...

  {
    ...
    description:
      "The Audi A4 is a compact executive car known for its technology, luxury, and smooth handling.",
    isAvaliable: true,
  ...
  },
  {
    ...
    location: "Austin",
    description:
      "The Tesla Model 3 is an electric car offering high-tech features, autopilot, and zero emissions.",
    isAvaliable: true,
  ...
  },
  {
    ...
    location: "Seattle",
    description:
      "The Mercedes-Benz GLC is a luxury compact SUV combining elegant design with performance and comfort.",
    isAvaliable: true,
